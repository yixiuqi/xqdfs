...
func init() {
	plugin.PluginAddService(constant.CmdStorageVolumeClear,ServiceStorageVolumeClear)
}

type RequestStorageVolumeClear struct {
	Id int32	`json:"id"`
	Vid int32	`json:"vid"`
}
func ServiceStorageVolumeClear(ctx context.Context,inv *plugin.Invocation) interface{}{
	req:=&RequestStorageVolumeClear{}
	...
	err=proxyStorage.StorageVolumeClear(storage.Addr,req.Vid,true)
	if err!=nil{
